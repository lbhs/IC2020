...
public class EnergyGlass : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
		...
		GameObject.Find("leftText").GetComponent<Text>().text = "Energy in Water: " + leftTotal.ToString() + " Joules";
		//GameObject.Find("rightText").GetComponent<Text>().text = "Right Energy: " + rightTotal.ToString() + " Joules";
		GameObject.Find("middleText").GetComponent<Text>().text = "Energy in Glass: " + middleTotal.ToString() + " Joules";
