...
public class ConversationTextDisplayScript: MonoBehaviour
{
    ...
    {
        ConversationTextBox.text = "Click on an atom to rotate it";
    ...
    {
        ConversationTextBox.text = "Use a Right Click or Long Tap to change the form of a carbon or oxygen atom";
