...
namespace IC2020
{
    public static class ICColor
    {
        ...
        */
        ...
        public static Color Bromine = new Color32(165, 42, 42, 255);
        ...
        public static Color Iodine = new Color32(148, 0, 148, 255);
        public static Color Copper = new Color32(199, 128, 52, 255);
        public static Color Fluorine = new Color32(130, 182, 255, 255);
        public static Color Boron = new Color32(255, 181, 181, 255);
        public static Color Zinc = new Color32(84, 179, 179, 255);
    }
    ...
    public class Particle
    {
        ...
        */
        ...
        public GameObject Spawn(float zr, Vector3 _pos = new Vector3(), bool overridden = false)
        {
            /*
    ...
    public class MoleculeSpawner
    {
        ...
        - since MoleculeSpawner is not static, it will need to be instanced in any scripts
          that require it.
        */
        public GameObject AddWater(float zr, float xd, float yd)
        {
            /*
            ...
            */
            ...
            float UnisonRandom = UnityEngine.Random.Range(-360f, 360f);
            GameObject _oxygen = oxygen.Spawn(UnisonRandom, new Vector3(xd, yd, 0));
            GameObject _hydrogen1 = hydrogen1.Spawn(0f, new Vector3(xd + hydrox, yd + hydroy, 0));
            
            GameObject _hydrogen2 = hydrogen2.Spawn(0f, new Vector3(xd + hhx, yd + hhy, 0));
            ...
            */
            ...
            //_oxygen.transform.Rotate(0, 0, zr);
            return null;
        }

        /*public GameObject HydrogenHalide(int selector)
        {
            Particle dHydrogen = new Particle("Dissociated Hydrogen", .1f, ICColor.Hydrogen, new Vector3(0, 0, 0), bounciness: 0.2f);
            ConfigurableJoint djoint;
            GameObject _dHydrogen = dHydrogen.Spawn(0f, new Vector3(0, 0, 0));
            djoint = _dHydrogen.AddComponent<ConfigurableJoint>();
            djoint.xMotion = ConfigurableJointMotion.Limited;
            djoint.yMotion = ConfigurableJointMotion.Limited;
            djoint.zMotion = ConfigurableJointMotion.Locked;
            djoint.angularXMotion = ConfigurableJointMotion.Limited;
            djoint.angularYMotion = ConfigurableJointMotion.Limited;
            djoint.angularZMotion = ConfigurableJointMotion.Locked;
            djoint.anchor = Vector3.down;
            djoint.angularXMotion = ConfigurableJointMotion.Limited;
            djoint.angularYMotion = ConfigurableJointMotion.Limited;
            djoint.angularZMotion = ConfigurableJointMotion.Locked;
            if (selector == 1)
            {
                Particle fluorine = new Particle("Fluorine", -1f, ICColor.Fluorine, new Vector3(1,1,1), bounciness: 0.2f);
                GameObject _fluorine = fluorine.Spawn(0f, new Vector3(1, 1, 1));
                djoint.connectedBody = _fluorine.GetComponent<Rigidbody>();
                _fluorine.transform.SetParent(_fluorine.transform);
            }
            if (selector == 2)
            {
                Particle chlorine = new Particle("Chlorine", -1f, ICColor.Chlorine, new Vector3(1,1,1), bounciness: 0.2f);
                GameObject _chlorine = chlorine.Spawn(0f, new Vector3(1, 1, 1));
                djoint.connectedBody = _chlorine.GetComponent<Rigidbody>();  
                _chlorine.transform.SetParent(_chlorine.transform);
            }
            if (selector == 3)
            {
                Particle bromine = new Particle("Bromine", -1f, ICColor.Bromine, new Vector3(1,1,1), bounciness: 0.2f);
                GameObject _bromine = bromine.Spawn(0f, new Vector3(1, 1, 1));
                djoint.connectedBody = _bromine.GetComponent<Rigidbody>();
                _bromine.transform.SetParent(_bromine.transform);
            }
            if (selector == 4)
            {
                Particle iodine = new Particle("Iodine", -1f, ICColor.Iodine, new Vector3(1,1,1), bounciness: 0.2f);
                GameObject _iodine = iodine.Spawn(0f, new Vector3(1, 1, 1));
                djoint.connectedBody = _iodine.GetComponent<Rigidbody>();
                _iodine.transform.SetParent(_iodine.transform);
            }
